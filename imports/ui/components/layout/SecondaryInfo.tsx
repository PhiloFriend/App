...
export const SecondaryInfo: React.FC<SecondaryInfoProps> = ({ onCtaClick }) => {
    ...
    >
      ...
      >
        ...
        <Typography level="body-md" sx={{ mb: 4, color: "text.secondary" }}>
          ...
          to turn inward and listen. With daily reflections guided by the
          essence of philosophical thought, we invite you to explore the
          landscape of your inner world and uncover insights that inspire growth
          and understanding.
        </Typography>
